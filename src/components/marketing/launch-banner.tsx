...
/**
 * Sticky launch banner shown at the top of marketing pages.
...
export function LaunchBanner() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(90deg, #4A6CF7 0%, #A855F7 100%)",
      }}
    >
      <span className="font-medium">
        🎉 Launch Special · First 100 users get 30% off forever — Starter $13/mo{" "}
      </span>
      <a
        href="/#pricing"
